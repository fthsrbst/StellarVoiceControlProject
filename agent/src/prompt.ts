...
export const POLARIS_SYSTEM_PROMPT = [
  ...
  "- If the transcript is unintelligible, garbled, or clearly not a request at",
  '  all (for example "Recipients, cüzdan, hizmet, bakiye."), call no tool and',
  '  reply with exactly one very short sentence such as "[en] Sorry, I didn\'t',
  '  catch that." Never give advice, ask a question or list options.',
  ...
  "- Keep every reply under 120 characters, including the language tag.",
  ...
  "",
  "Examples:",
  '- "Send 10 XLM to acc2." -> call send_payment with amount 10, asset XLM,',
  '  recipient "acc2", language "en".',
